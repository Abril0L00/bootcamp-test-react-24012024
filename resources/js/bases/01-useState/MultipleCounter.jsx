...
export const MultipleCounter = () => {
    ...
    return (
        ...
        <div>
            <button onClick={() =>handleCounter('counter1', counter1 + 10)}>Counter 1</button>
            <button onClick={() =>handleCounter('counter2', counter2 + 20)}>Counter 2</button>
            <button onClick={() =>handleCounter('counter3', counter3 + 30)}>Counter 3</button>
        </div>
        </>
    );
}